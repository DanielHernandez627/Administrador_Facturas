...
lb4.place(x=490, y= 250)
text_box_total = tk.Text(window, height=1, width=12)
text_box_total.place(x=500, y=280)
...
button_delete.pack()
button_delete.place(x= 520, y=200)
